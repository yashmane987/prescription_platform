...
const PatientSignup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await API.post('/auth/patient/signup', data);
  ...
  return (
    <Container maxWidth="sm">
      <Box mt={5}>
        <Typography variant="h4" align="center">Patient Signup</Typography>
        <form onSubmit={handleSubmit}>
          ...
          <TextField fullWidth margin="normal" label="Surgery History (comma separated)" name="surgeryHistory" multiline onChange={handleChange} />
          <TextField fullWidth margin="normal" label="Illness History (comma separated)" name="illnessHistory" multiline onChange={handleChange} />
